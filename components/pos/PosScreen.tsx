                    ...
                    <li key={item.instanceId} className="py-3 flex justify-between items-start">
                      ...
                      <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1 rounded-full bg-brand-primary hover:bg-gray-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-secondary"
                          ...
                          <button
                            ...
                            className="text-red-500 hover:text-red-400 p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded-md"
