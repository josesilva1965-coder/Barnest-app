...
const MenuItemCard: React.FC<{
    ...
    return (
        <button
            type="button"
            className="flex flex-col text-center items-center p-2 cursor-pointer hover:border-brand-secondary transition-all duration-200 bg-brand-dark border border-brand-primary rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-secondary focus:ring-offset-2 focus:ring-offset-brand-dark"
