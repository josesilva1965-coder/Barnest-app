        ...
        <div className="min-h-screen bg-brand-dark text-brand-light p-4 pb-24">
            ...
            {newItemsInCart.length > 0 && (
                <button
                    ...
                    className="fixed bottom-6 right-6 bg-brand-secondary text-white rounded-full p-4 shadow-lg flex items-center gap-2 animate-bounce focus:outline-none focus:ring-4 focus:ring-white"
                    aria-label={`View Cart. ${newItemsInCart.reduce((sum, item) => sum + item.quantity, 0)} items in cart.`}
                >
