...
const OrderCard: React.FC<OrderCardProps> = ({ order, onUpdateStatus, alertThreshold }) => {
    ...
    if (!alertSoundRef.current) {
        ...
        alertSoundRef.current = new Audio('data:audio/wav;base64,');
    }
